...
|TextNow|2|<li>其他-设为默认应用提示<li>权限类-通知/链接蓝牙附件设备|
...
|百度百科|1|<li>通知提示|
|百度地图|10|<li>开屏广告<li>局部广告-地图上方黄页横幅<li>局部广告-打车界面右侧悬浮球<li>全屏广告-美食大礼包弹窗<li>全屏广告-酒店提前订弹窗<li>权限类<li>全屏广告-打车界面弹窗广告<li>更新提示<li>通知提示<li>功能类-通勤卡添加至桌面|
...
|動畫瘋|1|<li>其他-动画疯年龄限制|
|抖音|2|<li>功能类-发现通讯录好友弹窗<li>权限类|
|抖音|18|<li>开屏广告<li>局部广告-关闭用户推荐<li>更新提示-关闭更新弹窗<li>局部广告-首页左上角广告<li>评价提示-去商店评分<li>功能类-设置无声进入抖音弹窗<li>通知提示<li>功能类-自动勾选原图<li>全屏广告-休息提醒<li>功能类-[添加快捷方式到桌面]弹窗<li>全屏广告-视频播放中途插入的打招呼界面<li>全屏广告-关闭商城推荐<li>局部广告-拍同款弹窗<li>全屏广告-[去首页商城]弹窗<li>全屏广告-低价秒杀券弹窗<li>权限类-请求访问通讯录弹窗<li>青少年模式<li>权限类|
...
|饿了么|9|<li>更新提示<li>全屏广告-红包弹窗<li>全屏广告-活动弹窗<li>全屏广告-付款后弹窗广告<li>全屏广告-吃货卡续费弹窗<li>局部广告-首页底部浮窗广告<li>权限类<li>通知提示-获取订单信息通知<li>评价提示-底部调研邀请卡片|
|鄂汇办|1|<li>开屏广告|
|儿歌多多|1|<li>局部广告-卡片广告|
...
|凤凰新闻|3|<li>开屏广告<li>分段广告-信息流广告<li>权限类|
|富民银行|1|<li>开屏广告|
|高德地图|10|<li>开屏广告<li>更新提示<li>功能类-截屏分享<li>局部广告-首页上方消息提醒<li>局部广告-首页签到卡片<li>全屏广告-加油页面优惠券弹窗<li>局部广告-卡片广告<li>全屏广告-弹窗广告<li>功能类-一键点亮角落<li>权限类-授权蓝牙|
|高佣联盟|1|<li>更新提示|
...
|果冻宝盒|1|<li>全屏广告-弹窗广告|
|哈啰|6|<li>更新提示<li>通知提示<li>权限类<li>全屏广告-弹窗广告<li>局部广告-右侧悬浮广告<li>其他-新人教学弹窗|
|海尔智家|2|<li>更新提示<li>通知提示|
|海南航空|1|<li>全屏广告-首页弹窗广告|
|海鸥加速器|2|<li>局部广告-卡片广告<li>全屏广告-谷歌广告|
|海星体育|1|<li>权限类-]权限授权]弹窗|
...
|麦当劳|4|<li>通知提示<li>全屏广告-弹窗广告<li>功能类-关闭[开通免密支付]弹窗<li>权限类-设备信息权限|
|脉脉|1|<li>开屏广告|
|慢慢买|1|<li>开屏广告|
...
|美团|10|<li>更新提示<li>全屏广告-弹窗广告<li>评价提示-订单调查弹窗<li>局部广告-悬浮广告<li>权限类<li>通知提示<li>全屏广告-新人返场特惠<li>全屏广告-视频页弹窗广告<li>功能类-付款后自动点击完成<li>局部广告-直播讲解悬浮窗|
...
|暮瑟|3|<li>局部广告-交友页面底部广告<li>全屏广告-漂流瓶页面提示弹窗<li>权限类|
...
|权限控制器|2|<li>功能类-相机允许本次<li>功能类-位置允许本次|
|热剧猫|1|<li>全屏广告-弹窗广告|
|人民日报|1|<li>全屏广告-弹窗广告|
|人民日报|1|<li>局部广告-卡片广告|
...
|山姆会员商店|3|<li>开屏广告<li>权限类<li>局部广告-关闭「您有一张亲友卡待赠送」通知条|
|闪电侠|1|<li>开屏广告|
...
|什么值得买|4|<li>全屏广告-弹窗广告<li>更新提示<li>权限类-请求读取剪贴板权限弹窗<li>通知提示|
...
|淘宝|14|<li>开屏广告<li>全屏广告-弹窗广告<li>局部广告-消息页面热门活动卡片<li>局部广告-悬浮广告<li>通知提示<li>功能类-各级页面添加到首页弹窗<li>更新提示<li>功能类-关闭小额免密支付<li>功能类-将小组件添加到手机桌面<li>权限类-悬浮窗权限<li>全屏广告-花呗升级报送征信<li>全屏广告-抢天降补贴弹窗<li>全屏广告-[「0元下单」权益]弹窗<li>局部广告-商品详情页直播悬浮窗|
...
|下载管理|1|<li>更新提示|
|闲鱼|6|<li>通知提示<li>权限类-手机信息权限<li>更新提示<li>全屏广告-红包弹窗<li>分段广告-搜索结果页广告<li>功能类-自动点击[查看原图]|
...
|小爱视觉|1|<li>更新提示|
|小爱音箱|2|<li>全屏广告-首页弹窗广告<li>权限类-请求开启定位权限弹窗|
...
|小米运动健康|4|<li>评价提示-好评弹窗<li>权限类-权限提醒<li>全屏广告-活动弹窗<li>更新提示|
|小牛加速器|1|<li>开屏广告|
|小柿子|1|<li>全屏广告-弹窗广告|
|小特|1|<li>开屏广告|
...
|云闪付|7|<li>分段广告-支付完成界面卡片广告<li>全屏广告-付款后信用卡广告<li>局部广告-右侧悬浮广告<li>权限类<li>通知提示<li>全屏广告-天天签到-获得新勋章提示<li>全屏广告-领取优惠弹窗|
...
|掌上生活|5|<li>更新提示<li>全屏广告-首页弹窗广告<li>局部广告-右侧悬浮广告<li>通知提示<li>权限类|
|掌上英雄联盟|3|<li>开屏广告<li>更新提示<li>全屏广告-弹窗广告|
|掌通家园|2|<li>更新提示<li>分段广告-信息流、文章底部广告|
|掌医课堂|2|<li>开屏广告<li>功能类-退出确认弹窗|
|掌阅|1|<li>更新提示|
|招商银行|3|<li>局部广告-首页活动悬浮广告<li>全屏广告-弹窗广告<li>权限类|
|找靓机|2|<li>全屏广告-超级补贴日弹窗<li>局部广告-卡片广告|
|浙里办|1|<li>更新提示|
|真不卡|4|<li>通知提示-温馨提示弹窗<li>分段广告-看视频领奖励广告<li>局部广告-卡片广告<li>全屏广告-弹窗广告|
|正气|1|<li>全屏广告-弹窗广告|
|支付宝|17|<li>全屏广告-关闭花呗升级弹窗<li>权限类<li>通知提示<li>更新提示-版本更新弹窗<li>功能类-设置支付宝小组件<li>全屏广告-借呗消费信贷协议<li>功能类-支付后自动点击完成<li>全屏广告-弹窗广告<li>全屏广告-"下次支付用花呗"弹窗<li>分段广告-扫码乘车后出现的广告<li>功能类-关闭免密支付开关<li>分段广告-服务消息页面-卡片广告<li>全屏广告-[0元下单权益]弹窗<li>局部广告-卡片广告<li>其他-蚂蚁理财社区-[加入同路人]弹窗<li>全屏广告-[银行卡还款服务升级]弹窗<li>开屏广告-小程序开屏广告|
|芝士漫画|1|<li>全屏广告-弹窗广告|
...
|中国联通|4|<li>权限类<li>更新提示<li>全屏广告-弹窗广告<li>局部广告-首页右下角卡片悬浮窗|
|中国农业银行|4|<li>开屏广告<li>更新提示<li>权限类<li>通知提示|
|中国人保|1|<li>更新提示|
|中国移动|8|<li>开屏广告<li>更新提示<li>全屏广告-首页弹窗广告<li>通知提示<li>权限类-请求获取剪贴板权限弹窗<li>局部广告-右侧悬浮小图标<li>评价提示-请求好评弹窗<li>权限类-通讯录权限申请弹窗|
...
|自考笔果题库|3|<li>更新提示<li>全屏广告-首页弹窗广告<li>权限类|
