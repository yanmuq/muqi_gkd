...
|淘宝|11|<li>开屏广告<li>全屏广告-弹窗广告<li>局部广告-消息页面热门活动卡片<li>局部广告-悬浮广告<li>提示类-开启通知弹窗<li>更新提示<li>功能类-关闭小额免密支付<li>功能类-将小组件添加到手机桌面<li>功能类-悬浮窗权限<li>全屏广告-抢天降补贴弹窗<li>局部广告-商品详情页直播悬浮窗|
|铁路12306|1|<li>开屏广告|
