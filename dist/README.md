...
||||
| - |:-:|-|
|5EPlay|2|<li>通知提示<li>局部广告-首页右下角浮窗|
|AfuseKt|1|<li>更新提示|
...
|Jump|3|<li>开屏广告<li>通知提示<li>局部广告-信息流广告/卡片广告|
...
|Soul|6|<li>开屏广告<li>局部广告-广场页卡片广告<li>评价提示-app评分<li>更新提示<li>通知提示<li>局部广告-帖子详情页卡片广告|
...
|TextNow|2|<li>其他-设为默认应用提示<li>权限请求-通知/链接蓝牙附件设备|
...
|youtube|5|<li>全屏广告-视频播放-跳过广告<li>全屏广告-视频播放-赞助商广告<li>全屏广告-会员广告<li>通知提示<li>功能类-自动翻译评论|
...
|爱奇艺|5|<li>开屏广告<li>局部广告-顶部卡片广告<li>通知提示<li>更新提示<li>全屏广告-播放页-插入广告|
|爱奇艺极速版|1|<li>开屏广告|
|爱奇艺体育|1|<li>开屏广告|
...
|百度百科|1|<li>通知提示|
|百度地图|10|<li>开屏广告<li>局部广告-地图上方黄页横幅<li>局部广告-打车界面右侧悬浮球<li>全屏广告-美食大礼包弹窗<li>全屏广告-酒店提前订弹窗<li>权限请求<li>全屏广告-打车界面弹窗广告<li>更新提示<li>通知提示<li>功能类-通勤卡添加至桌面|
|百度输入法|3|<li>开屏广告<li>全屏广告-创作祝福弹窗<li>局部广告-底部会员悬浮卡片|
|百度输入法定制版|1|<li>开屏广告|
|百度贴吧|13|<li>开屏广告<li>通知提示<li>分段广告-信息流广告<li>局部广告-首页、推荐列表顶部卡片广告<li>更新提示<li>全屏广告-弹窗广告<li>局部广告-悬浮小广告<li>局部广告-[帖子内/吧内]底部悬浮窗<li>功能类-贴吧内签到并关闭弹窗<li>局部广告-帖子底部话题卡片<li>全屏广告-会员弹窗<li>局部广告-信息流广告<li>局部广告-帖子推广|
...
|哔哩哔哩|14|<li>开屏广告<li>局部广告-评论区顶部公告横幅<li>分段广告-动态推荐卡片广告<li>分段广告-视频底部与评论区中间卡片广告<li>更新提示<li>局部广告-视频悬浮广告<li>局部广告-直播间卡片广告<li>通知提示<li>分段广告-首页推荐视频卡片广告<li>局部广告-个性化内容推荐弹窗<li>全屏广告-会员弹窗<li>全屏广告-分享稿件弹窗<li>分段广告-搜索结果广告<li>分段广告-视频详情页下方推广|
...
|動畫瘋|1|<li>其他-动画疯年龄限制|
|抖音|2|<li>功能类-发现通讯录好友弹窗<li>权限请求|
|抖音|18|<li>开屏广告<li>局部广告-关闭用户推荐<li>更新提示-关闭更新弹窗<li>局部广告-首页左上角广告<li>评价提示-去商店评分<li>功能类-设置无声进入抖音弹窗<li>通知提示<li>功能类-自动勾选原图<li>全屏广告-休息提醒<li>功能类-[添加快捷方式到桌面]弹窗<li>全屏广告-视频播放中途插入的打招呼界面<li>全屏广告-关闭商城推荐<li>局部广告-拍同款弹窗<li>全屏广告-[去首页商城]弹窗<li>全屏广告-低价秒杀券弹窗<li>权限请求-请求访问通讯录弹窗<li>青少年模式<li>权限请求|
|抖音极速版|4|<li>功能类-功能体验邀请弹窗<li>全屏广告-朋友推荐弹窗<li>通知提示<li>功能类-选择图片时自动勾选原图|
...
|堆糖|4|<li>局部广告-信息流广告<li>评价提示<li>全屏广告-图片页弹窗广告<li>通知提示|
...
|饿了么|9|<li>更新提示<li>全屏广告-红包弹窗<li>全屏广告-活动弹窗<li>全屏广告-付款后弹窗广告<li>全屏广告-吃货卡续费弹窗<li>局部广告-首页底部浮窗广告<li>权限请求<li>通知提示-获取订单信息通知<li>评价提示-底部调研邀请卡片|
|鄂汇办|1|<li>开屏广告|
|儿歌多多|1|<li>局部广告-卡片广告|
|二柄|2|<li>开屏广告<li>分段广告|
|番茄免费小说|10|<li>局部广告-阅读页面广告<li>更新提示<li>局部广告-首页右侧悬浮广告<li>全屏广告-弹窗广告<li>全屏广告-阅读页面关注作者弹窗<li>分段广告-阅读页面广告<li>评价提示-请求好评弹窗<li>通知提示<li>全屏广告<li>全屏广告-会员福利弹窗|
|返利|1|<li>全屏广告-弹窗广告|
|飞常准业内版|1|<li>开屏广告|
|飞客|1|<li>全屏广告-弹窗广告|
...
|凤凰新闻|3|<li>开屏广告<li>分段广告-信息流广告<li>权限请求|
|富民银行|1|<li>开屏广告|
|高德地图|10|<li>开屏广告<li>更新提示<li>功能类-截屏分享<li>局部广告-首页上方消息提醒<li>局部广告-首页签到卡片<li>全屏广告-加油页面优惠券弹窗<li>局部广告-卡片广告<li>全屏广告-弹窗广告<li>功能类-一键点亮角落<li>权限请求-授权蓝牙|
|高佣联盟|1|<li>更新提示|
|个人图书馆|1|<li>局部广告-信息流广告|
|工程相机|2|<li>开屏广告<li>全屏广告-弹窗广告|
|公考雷达|2|<li>局部广告-首页右侧悬浮广告<li>通知提示|
|呱呱天气|1|<li>局部广告-卡片广告|
|咕咚|1|<li>全屏广告-弹窗广告|
|古诗文网|1|<li>分段广告-弹窗广告|
|古文岛|1|<li>全屏广告-弹窗广告|
...
|果冻宝盒|1|<li>全屏广告-弹窗广告|
|哈啰|6|<li>更新提示<li>通知提示<li>权限请求<li>全屏广告-弹窗广告<li>局部广告-右侧悬浮广告<li>其他-新人教学弹窗|
|海尔智家|2|<li>更新提示<li>通知提示|
|海南航空|1|<li>全屏广告-首页弹窗广告|
|海鸥加速器|2|<li>局部广告-卡片广告<li>全屏广告-谷歌广告|
|海星体育|1|<li>权限请求-]权限授权]弹窗|
...
|华为主题|5|<li>开屏广告<li>局部广告-悬浮广告<li>分段广告-卡片广告<li>全屏广告-首页活动弹窗<li>通知提示|
|欢律|1|<li>更新提示|
|会计云课堂|1|<li>开屏广告|
|集换社|1|<li>开屏广告|
...
|今日头条|12|<li>开屏广告<li>更新提示<li>局部广告-浮窗广告<li>通知提示<li>全屏广告-竖屏视频广告<li>分段广告-信息流广告<li>局部广告-底部话题推荐弹窗<li>功能类-自动观看广告视频<li>局部广告-底部热榜弹窗<li>功能类-[关联抖音账号]弹窗<li>功能类-[下次打开APP默认进入发现频道]弹窗<li>全屏广告-弹窗广告|
|今日校园|1|<li>更新提示|
|金山文档|3|<li>局部广告-列表卡片广告<li>更新提示<li>通知提示|
|金十数据|4|<li>更新提示<li>全屏广告-首页弹窗广告<li>全屏广告-快讯页面弹窗广告<li>局部广告-会员页面顶部广告|
|京东|11|<li>开屏广告<li>局部广告-购物车页面砸金蛋<li>局部广告-悬浮广告<li>通知提示<li>全屏广告-弹窗广告<li>局部广告-横幅广告<li>功能类-京东账号登录授权<li>局部广告-支付页面产品推荐<li>全屏广告-购物车页面支付成功弹窗广告<li>全屏广告-加入购物车后出现的弹窗<li>功能类-支付订单后点击[完成]|
...
|酷安|5|<li>开屏广告<li>分段广告-信息流广告<li>更新提示<li>通知提示<li>局部广告-[大家还下载了]应用推荐|
...
|雷神加速器|3|<li>开屏广告<li>全屏广告-弹窗广告<li>通知提示|
|联通云盘|1|<li>更新提示|
...
|麦当劳|4|<li>通知提示<li>全屏广告-弹窗广告<li>功能类-关闭[开通免密支付]弹窗<li>权限请求-设备信息权限|
|脉脉|1|<li>开屏广告|
|慢慢买|1|<li>开屏广告|
...
|美团|10|<li>更新提示<li>全屏广告-弹窗广告<li>评价提示-订单调查弹窗<li>局部广告-悬浮广告<li>权限请求<li>通知提示<li>全屏广告-新人返场特惠<li>全屏广告-视频页弹窗广告<li>功能类-付款后自动点击完成<li>局部广告-直播讲解悬浮窗|
|美团外卖|3|<li>更新提示<li>全屏广告-弹窗广告<li>局部广告-直播悬浮窗|
|美团众包|2|<li>全屏广告-弹窗广告<li>其他-[保级成功]弹窗|
|美柚|1|<li>局部广告-评论区上方卡片广告|
|咪咕快游|1|<li>更新提示|
|咪咕视频|4|<li>局部广告-右下角小广告<li>更新提示<li>通知提示<li>全屏广告-弹窗广告|
...
|暮瑟|3|<li>局部广告-交友页面底部广告<li>全屏广告-漂流瓶页面提示弹窗<li>权限请求|
...
|拼多多|12|<li>更新提示<li>全屏广告-弹窗广告<li>局部广告-悬浮广告<li>局部广告-商品详情页视频讲解窗口<li>功能类-多多视频每日自动签到<li>全屏广告-多多视频划到广告自动跳过<li>功能类-发送图片时自动勾选原图<li>全屏广告-下单后出现的弹窗<li>青少年模式<li>通知提示<li>全屏广告-[个性化推荐]弹窗<li>其他-登录提现页面点击[跳过]|
|浦发银行|1|<li>通知提示|
...
|起点读书|10|<li>更新提示<li>青少年模式<li>全屏广告-活动弹窗<li>通知提示<li>局部广告-悬浮广告<li>功能类-起点中文网登录自动确认<li>局部广告-信息流广告<li>其他-福利中心看视频后获得奖励<li>全屏广告-红包弹窗<li>功能类-移动网络下自动点击播放视频|
...
|山姆会员商店|3|<li>开屏广告<li>权限请求<li>局部广告-关闭「您有一张亲友卡待赠送」通知条|
|闪电侠|1|<li>开屏广告|
...
|什么值得买|4|<li>全屏广告-弹窗广告<li>更新提示<li>权限请求-请求读取剪贴板权限弹窗<li>通知提示|
|十六番旅行|3|<li>开屏广告<li>分段广告-卡片广告<li>通知提示|
...
|泰剧兔|1|<li>全屏广告-弹窗广告|
|探探|2|<li>更新提示<li>通知提示|
|糖豆|3|<li>更新提示<li>全屏广告-视频播放前的广告<li>全屏广告-弹窗广告|
|糖心Vlog|3|<li>开屏广告<li>全屏广告-弹窗广告<li>全屏广告-公告弹窗|
|淘宝|14|<li>开屏广告<li>全屏广告-弹窗广告<li>局部广告-消息页面热门活动卡片<li>局部广告-悬浮广告<li>通知提示<li>功能类-各级页面添加到首页弹窗<li>更新提示<li>功能类-关闭小额免密支付<li>功能类-将小组件添加到手机桌面<li>权限请求-悬浮窗权限<li>全屏广告-花呗升级报送征信<li>全屏广告-抢天降补贴弹窗<li>全屏广告-[「0元下单」权益]弹窗<li>局部广告-商品详情页直播悬浮窗|
...
|腾讯会议|1|<li>更新提示|
|腾讯视频|8|<li>开屏广告<li>更新提示<li>分段广告-卡片广告<li>全屏广告-视频播放时的广告<li>全屏广告-首页-弹窗广告<li>通知提示<li>局部广告-卡片广告<li>局部广告-悬浮广告|
...
|网易新闻|2|<li>通知提示<li>分段广告-首页信息流广告|
...
|微博|17|<li>全屏广告-兴趣领域推荐<li>全屏广告-精选博主推荐<li>局部广告-博文内容区与评论区中间卡片广告<li>分段广告-评论区博主内容推荐<li>局部广告-首页顶部话题分享窗口<li>全屏广告-弹窗广告<li>通知提示<li>局部广告-首页顶部签到卡片<li>局部广告-悬浮广告<li>权限请求<li>分段广告-信息流广告<li>评价提示-APP评分弹窗<li>功能类-自动点击查看原图<li>功能类-超话自动签到<li>功能类-超话一键签到<li>功能类-关闭猪手提示<li>功能类-关闭点赞时的验证|
|微博极速版|2|<li>分段广告-信息流广告<li>评价提示-APP评分弹窗|
|微博轻享版|2|<li>开屏广告<li>分段广告-信息流广告|
|微店|1|<li>全屏广告-首页红包弹窗|
|微拾|2|<li>分段广告-我的页面卡片广告<li>全屏广告-弹窗广告|
|微信|24|<li>分段广告-朋友圈广告<li>功能类-电脑微信快捷自动登录<li>功能类-自动授权登录<li>功能类-微信读书网页版扫码登录自动授权<li>功能类-微信红包自动领取<li>功能类-自动选中发送原图<li>功能类-自动查看原图<li>开屏广告-微信小程序<li>功能类-网页版文件传输助手扫码自动授权<li>青少年模式<li>功能类-青少年模式自动点击验证密码<li>功能类-订阅号-展开更早的消息<li>功能类-开启青少年模式后的每日验证<li>局部广告-订阅号消息-推荐文章<li>功能类-付款后自动点击完成/返回商家<li>分段广告-订阅号消息-视频推荐<li>功能类-解锁 Windows 微信<li>全屏广告-文档页面-腾讯文档APP弹窗<li>分段广告-订阅号消息-推荐阅读<li>权限请求-权限申请弹窗<li>功能类-付款时自动点击[支付]<li>分段广告-订阅号消息内容-广告<li>功能类-自动点击[查看原视频]<li>全屏广告-小程序弹窗广告|
|微信读书|1|<li>通知提示|
|文件|2|<li>功能类-允许第三方应用访问文件夹<li>功能类-使用此文件夹|
|文心一言|1|<li>更新提示|
|我爱卡|2|<li>权限请求<li>权限请求-请求位置、存储权限|
|我的荣耀|2|<li>全屏广告-弹窗广告<li>权限请求|
|我的听书|3|<li>局部广告-卡片广告<li>全屏广告-弹窗广告<li>分段广告-播放页卡片广告|
|无界趣连|1|<li>更新提示|
|无线魔盒|1|<li>更新提示|
|无忧行|3|<li>全屏广告-弹窗广告<li>权限请求<li>权限请求-权限申请弹窗|
|五寸方|1|<li>全屏广告-弹窗广告|
|西瓜视频|4|<li>开屏广告<li>更新提示<li>通知提示<li>全屏广告-红包弹窗|
|息壤阅读|1|<li>局部广告-悬浮广告|
|稀饭动漫|1|<li>全屏广告-弹窗广告|
|稀土掘金|1|<li>更新提示|
|喜马拉雅|12|<li>开屏广告<li>局部广告-首页右侧浮动广告<li>局部广告-播放页面-播放控制区域的广告<li>分段广告-播放页面-底部推荐列表-夹杂广告<li>局部广告-播放页面-播放前广告<li>分段广告-信息流广告<li>局部广告-热播推荐广告<li>青少年模式<li>局部广告-评论区广告<li>全屏广告-首页-专辑订阅推荐弹窗<li>全屏广告-弹窗广告<li>通知提示|
|喜马拉雅极速版|4|<li>全屏广告-弹窗广告<li>全屏广告-小说推荐弹窗<li>全屏广告-支付宝提现弹窗广告<li>通知提示|
...
|下载管理|1|<li>更新提示|
|闲鱼|6|<li>通知提示<li>权限请求-手机信息权限<li>更新提示<li>全屏广告-红包弹窗<li>分段广告-搜索结果页广告<li>功能类-自动点击[查看原图]|
...
|小爱视觉|1|<li>更新提示|
|小爱音箱|2|<li>全屏广告-首页弹窗广告<li>权限请求-请求开启定位权限弹窗|
...
|小红帽|1|<li>全屏广告-弹窗广告|
|小红书|6|<li>开屏广告<li>通知提示<li>更新提示<li>分段广告-信息流广告<li>全屏广告-优惠券弹窗<li>评价提示-评分弹窗|
|小美智能|1|<li>更新提示|
|小米换机|1|<li>更新提示|
...
|小米运动健康|4|<li>评价提示-好评弹窗<li>权限请求-权限提醒<li>全屏广告-活动弹窗<li>更新提示|
|小牛加速器|1|<li>开屏广告|
|小柿子|1|<li>全屏广告-弹窗广告|
|小特|1|<li>开屏广告|
...
|迅雷|9|<li>开屏广告<li>分段广告-视频详情页广告<li>分段广告-视频详情页直播推荐<li>全屏广告-弹窗广告<li>分段广告-"下载页"卡片广告<li>更新提示<li>全屏广告-会员广告<li>局部广告-卡片广告<li>通知提示|
...
|一刻相册|8|<li>更新提示-软件升级提醒<li>局部广告-悬浮窗广告<li>评价提示<li>全屏广告-会员弹窗<li>全屏广告-弹窗广告<li>通知提示<li>局部广告-照片页底部浮窗广告<li>局部广告-卡片广告|
|一起来涂色|1|<li>分段广告-底部穿山甲广告|
|一淘|2|<li>全屏广告-弹窗广告<li>通知提示|
...
|云闪付|7|<li>分段广告-支付完成界面卡片广告<li>全屏广告-付款后信用卡广告<li>局部广告-右侧悬浮广告<li>权限请求<li>通知提示<li>全屏广告-天天签到-获得新勋章提示<li>全屏广告-领取优惠弹窗|
...
|掌上生活|5|<li>更新提示<li>全屏广告-首页弹窗广告<li>局部广告-右侧悬浮广告<li>通知提示<li>权限请求|
|掌上英雄联盟|3|<li>开屏广告<li>更新提示<li>全屏广告-弹窗广告|
|掌通家园|2|<li>更新提示<li>分段广告-信息流、文章底部广告|
|掌医课堂|2|<li>开屏广告<li>功能类-退出确认弹窗|
|掌阅|1|<li>更新提示|
|招商银行|3|<li>局部广告-首页活动悬浮广告<li>全屏广告-弹窗广告<li>权限请求|
|找靓机|2|<li>全屏广告-超级补贴日弹窗<li>局部广告-卡片广告|
|浙里办|1|<li>更新提示|
|真不卡|4|<li>通知提示-温馨提示弹窗<li>分段广告-看视频领奖励广告<li>局部广告-卡片广告<li>全屏广告-弹窗广告|
|正气|1|<li>全屏广告-弹窗广告|
|支付宝|17|<li>全屏广告-关闭花呗升级弹窗<li>权限请求<li>通知提示<li>更新提示-版本更新弹窗<li>功能类-设置支付宝小组件<li>全屏广告-借呗消费信贷协议<li>功能类-支付后自动点击完成<li>全屏广告-弹窗广告<li>全屏广告-"下次支付用花呗"弹窗<li>分段广告-扫码乘车后出现的广告<li>功能类-关闭免密支付开关<li>分段广告-服务消息页面-卡片广告<li>全屏广告-[0元下单权益]弹窗<li>局部广告-卡片广告<li>其他-蚂蚁理财社区-[加入同路人]弹窗<li>全屏广告-[银行卡还款服务升级]弹窗<li>开屏广告-小程序开屏广告|
...
|中国联通|4|<li>权限请求<li>更新提示<li>全屏广告-弹窗广告<li>局部广告-首页右下角卡片悬浮窗|
|中国农业银行|4|<li>开屏广告<li>更新提示<li>权限请求<li>通知提示|
|中国人保|1|<li>更新提示|
|中国移动|8|<li>开屏广告<li>更新提示<li>全屏广告-首页弹窗广告<li>通知提示<li>权限请求-请求获取剪贴板权限弹窗<li>局部广告-右侧悬浮小图标<li>评价提示-请求好评弹窗<li>权限请求-通讯录权限申请弹窗|
|中国移动河南|2|<li>全屏广告-弹窗广告<li>局部广告-右侧悬浮广告|
|中国移动江苏|1|<li>通知提示|
|中国移动云盘|5|<li>更新提示<li>全屏广告-弹窗广告<li>局部广告-悬浮广告<li>全屏广告-请求开启自动备份弹窗<li>通知提示|
|中国银行|1|<li>全屏广告-弹窗广告|
|中国邮政|1|<li>全屏广告-首页弹窗|
...
|自考笔果题库|3|<li>更新提示<li>全屏广告-首页弹窗广告<li>权限请求|
|最右|4|<li>开屏广告<li>更新提示<li>分段广告-评论区卡片广告<li>通知提示|
|最准天气|1|<li>局部广告-卡片广告|
|作业帮|1|<li>全屏广告-弹窗广告|
...
|UC浏览器|4|<li>开屏广告<li>分段广告-信息流广告<li>通知提示<li>其他-请求添加桌面快捷方式弹窗|
|UPUPOO动态壁纸|2|<li>开屏广告<li>青少年模式|
|VIVO 电子书|2|<li>权限请求<li>通知提示|
|vivo 官网|3|<li>开屏广告<li>全屏广告-活动广告<li>通知提示|
|vivo浏览器|3|<li>开屏广告<li>功能类-免流提示<li>局部广告-天气详情页面|
|vivo应用商店|2|<li>通知提示<li>全屏广告-热门应用推荐|
