...
|百度百科|1|<li>通知提示|
|百度地图|10|<li>开屏广告<li>局部广告-地图上方黄页横幅<li>局部广告-打车界面右侧悬浮球<li>全屏广告-美食大礼包弹窗<li>全屏广告-酒店提前订弹窗<li>定位提示<li>全屏广告-打车界面弹窗广告<li>更新提示<li>通知提示<li>功能类-通勤卡添加至桌面|
...
|動畫瘋|1|<li>其他-动画疯年龄限制|
|抖音|2|<li>功能类-发现通讯录好友弹窗<li>定位提示|
|抖音|18|<li>开屏广告<li>局部广告-关闭用户推荐<li>更新提示-关闭更新弹窗<li>局部广告-首页左上角广告<li>评价提示-去商店评分<li>功能类-设置无声进入抖音弹窗<li>通知提示<li>功能类-自动勾选原图<li>全屏广告-休息提醒<li>功能类-[添加快捷方式到桌面]弹窗<li>全屏广告-视频播放中途插入的打招呼界面<li>全屏广告-关闭商城推荐<li>局部广告-拍同款弹窗<li>全屏广告-[去首页商城]弹窗<li>全屏广告-低价秒杀券弹窗<li>权限提示-请求访问通讯录弹窗<li>青少年模式<li>定位提示|
...
|凤凰新闻|3|<li>开屏广告<li>分段广告-信息流广告<li>定位提示|
|富民银行|1|<li>开屏广告|
...
|果冻宝盒|1|<li>全屏广告-弹窗广告|
|哈啰|6|<li>更新提示<li>通知提示<li>定位提示<li>全屏广告-弹窗广告<li>局部广告-右侧悬浮广告<li>其他-新人教学弹窗|
...
|麦当劳|4|<li>通知提示<li>全屏广告-弹窗广告<li>功能类-关闭[开通免密支付]弹窗<li>权限提示-设备信息权限|
|脉脉|1|<li>开屏广告|
|慢慢买|1|<li>开屏广告|
...
|美团|10|<li>更新提示<li>全屏广告-弹窗广告<li>评价提示-订单调查弹窗<li>局部广告-悬浮广告<li>定位提示<li>通知提示<li>全屏广告-新人返场特惠<li>全屏广告-视频页弹窗广告<li>功能类-付款后自动点击完成<li>局部广告-直播讲解悬浮窗|
...
|暮瑟|3|<li>局部广告-交友页面底部广告<li>全屏广告-漂流瓶页面提示弹窗<li>定位提示|
...
|淘宝|14|<li>开屏广告<li>全屏广告-弹窗广告<li>局部广告-消息页面热门活动卡片<li>局部广告-悬浮广告<li>通知提示<li>功能类-各级页面添加到首页弹窗<li>更新提示<li>功能类-关闭小额免密支付<li>功能类-将小组件添加到手机桌面<li>权限提示-悬浮窗权限<li>全屏广告-花呗升级报送征信<li>全屏广告-抢天降补贴弹窗<li>全屏广告-[「0元下单」权益]弹窗<li>局部广告-商品详情页直播悬浮窗|
...
|微博|17|<li>全屏广告-兴趣领域推荐<li>全屏广告-精选博主推荐<li>局部广告-博文内容区与评论区中间卡片广告<li>分段广告-评论区博主内容推荐<li>局部广告-首页顶部话题分享窗口<li>全屏广告-弹窗广告<li>通知提示<li>局部广告-首页顶部签到卡片<li>局部广告-悬浮广告<li>定位提示<li>分段广告-信息流广告<li>评价提示-APP评分弹窗<li>功能类-自动点击查看原图<li>功能类-超话自动签到<li>功能类-超话一键签到<li>功能类-关闭猪手提示<li>功能类-关闭点赞时的验证|
...
|下载管理|1|<li>更新提示|
|闲鱼|6|<li>通知提示<li>权限提示-手机信息权限<li>更新提示<li>全屏广告-红包弹窗<li>分段广告-搜索结果页广告<li>功能类-自动点击[查看原图]|
...
|云闪付|7|<li>分段广告-支付完成界面卡片广告<li>全屏广告-付款后信用卡广告<li>局部广告-右侧悬浮广告<li>定位提示<li>通知提示<li>全屏广告-天天签到-获得新勋章提示<li>全屏广告-领取优惠弹窗|
...
|正气|1|<li>全屏广告-弹窗广告|
|支付宝|17|<li>全屏广告-关闭花呗升级弹窗<li>定位提示<li>通知提示<li>更新提示-版本更新弹窗<li>功能类-设置支付宝小组件<li>全屏广告-借呗消费信贷协议<li>功能类-支付后自动点击完成<li>全屏广告-弹窗广告<li>全屏广告-"下次支付用花呗"弹窗<li>分段广告-扫码乘车后出现的广告<li>功能类-关闭免密支付开关<li>分段广告-服务消息页面-卡片广告<li>全屏广告-[0元下单权益]弹窗<li>局部广告-卡片广告<li>其他-蚂蚁理财社区-[加入同路人]弹窗<li>全屏广告-[银行卡还款服务升级]弹窗<li>开屏广告-小程序开屏广告|
...
|知网文化|1|<li>更新提示|
|直播吧|3|<li>分段广告-信息流广告<li>更新提示<li>通知提示|
|志愿汇|1|<li>全屏广告-弹窗广告|
